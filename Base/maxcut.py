...
def maxcut_obj(x: np.ndarray, w: np.ndarray):
...
def get_maxcut_terms(G: nx.Graph):
...
def get_adjacency_matrix(G: nx.Graph):
...
G = nx.erdos_renyi_graph(4, .5, seed=123)

print(get_maxcut_terms(G))
