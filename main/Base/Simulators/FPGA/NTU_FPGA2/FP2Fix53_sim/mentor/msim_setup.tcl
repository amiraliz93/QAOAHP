...
# ----------------------------------------
# If FP2Fix53 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 25.1 1129 win32 2026.04.18.01:25:34
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FP2Fix53.vo"
}
