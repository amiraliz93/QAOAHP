...
# ACDS 25.1 1129 win32 2026.04.18.01:11:16
# ----------------------------------------
...
# ----------------------------------------
# If cordicR is one of several IP cores in your
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/cordicR_CORDIC_0.vhd"      -work CORDIC_0
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/cordicR.v"                                          
}
