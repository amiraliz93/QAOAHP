...
//altfp_add_sub DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix V" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clock dataa datab nan overflow result underflow zero
...
//altbarrel_shift DEVICE_FAMILY="Stratix V" PIPELINE=1 SHIFTDIR="LEFT" WIDTH=55 WIDTHDIST=6 aclr clk_en clock data distance result
...
module  addFP64_altbarrel_shift
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //addFP64_altbarrel_shift


//altbarrel_shift DEVICE_FAMILY="Stratix V" PIPELINE=1 REGISTER_OUTPUT="NO" SHIFTDIR="RIGHT" WIDTH=55 WIDTHDIST=6 aclr clk_en clock data distance result
//VERSION_BEGIN 17.1 cbx_altbarrel_shift 2017:10:25:18:06:52:SJ cbx_mgl 2017:10:25:18:08:29:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altbarrel_shift1
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		smux_w = {((({55{(sel_w[5] & (~ dir_w[5]))}} & {sbit_w[297:275], pad_w[31:0]}) | ({55{(sel_w[5] & dir_w[5])}} & {pad_w[31:0], sbit_w[329:307]})) | ({55{(~ sel_w[5])}} & sbit_w[329:275])), ((({55{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[258:220], pad_w[15:0]}) | ({55{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[274:236]})) | ({55{(~ sel_w[4])}} & sbit_w[274:220])), ((({55{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[211:165], pad_w[7:0]}) | ({55{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[219:173]})) | ({55{(~ sel_w[3])}} & sbit_w[219:165])), ((({55{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[160:110], pad_w[3:0]}) | ({55{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[164:114]})) | ({55{(~ sel_w[2])}} & sbit_w[164:110])), ((({55{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[107:55], pad_w[1:0]}) | ({55{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[109:57]})) | ({55{(~ sel_w[1])}} & sbit_w[109:55])), ((({55{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[53:0], pad_w[0]}) | ({55{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[54:1]})) | ({55{(~ sel_w[0])}} & sbit_w[54:0]))};
endmodule //addFP64_altbarrel_shift1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder12345
	( 
	data,
	q,
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //addFP64_altpriority_encoder12345

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder1234
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	addFP64_altpriority_encoder12345   altpriority_encoder15
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	addFP64_altpriority_encoder12345   altpriority_encoder16
	( 
	.data(data[3:2]),
...
endmodule //addFP64_altpriority_encoder1234

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder123
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	addFP64_altpriority_encoder1234   altpriority_encoder13
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	addFP64_altpriority_encoder1234   altpriority_encoder14
	( 
	.data(data[7:4]),
...
endmodule //addFP64_altpriority_encoder123

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder12
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	addFP64_altpriority_encoder123   altpriority_encoder11
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	addFP64_altpriority_encoder123   altpriority_encoder12
	( 
	.data(data[15:8]),
...
endmodule //addFP64_altpriority_encoder12
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder123456789
	( 
	data,
	...
	assign
		q = {data[1]};
endmodule //addFP64_altpriority_encoder123456789

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder12345678
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [3:0]  data;
	...
	addFP64_altpriority_encoder123456789   altpriority_encoder21
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder21_q));
	addFP64_altpriority_encoder12345   altpriority_encoder22
	( 
	.data(data[3:2]),
...
endmodule //addFP64_altpriority_encoder12345678

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder1234567
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [7:0]  data;
	...
	addFP64_altpriority_encoder12345678   altpriority_encoder19
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder19_q));
	addFP64_altpriority_encoder1234   altpriority_encoder20
	( 
	.data(data[7:4]),
...
endmodule //addFP64_altpriority_encoder1234567

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder123456
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [15:0]  data;
	...
	addFP64_altpriority_encoder1234567   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	addFP64_altpriority_encoder123   altpriority_encoder18
	( 
	.data(data[15:8]),
...
endmodule //addFP64_altpriority_encoder123456

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder1
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [31:0]  data;
	...
	addFP64_altpriority_encoder12   altpriority_encoder10
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	addFP64_altpriority_encoder123456   altpriority_encoder9
	( 
	.data(data[15:0]),
...
endmodule //addFP64_altpriority_encoder1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder12345678910
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	addFP64_altpriority_encoder12   altpriority_encoder23
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	addFP64_altpriority_encoder12   altpriority_encoder24
	( 
	.data(data[31:16]),
...
endmodule //addFP64_altpriority_encoder12345678910

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	addFP64_altpriority_encoder1   altpriority_encoder7
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder7_q));
	addFP64_altpriority_encoder12345678910   altpriority_encoder8
	( 
	.data(data[63:32]),
...
endmodule //addFP64_altpriority_encoder
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder12345678910111213141516
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //addFP64_altpriority_encoder12345678910111213141516

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder123456789101112131415
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	addFP64_altpriority_encoder12345678910111213141516   altpriority_encoder33
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder33_q),
	.zero(wire_altpriority_encoder33_zero));
	addFP64_altpriority_encoder12345678910111213141516   altpriority_encoder34
	( 
	.data(data[3:2]),
...
endmodule //addFP64_altpriority_encoder123456789101112131415

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder1234567891011121314
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	addFP64_altpriority_encoder123456789101112131415   altpriority_encoder31
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	addFP64_altpriority_encoder123456789101112131415   altpriority_encoder32
	( 
	.data(data[7:4]),
...
endmodule //addFP64_altpriority_encoder1234567891011121314

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder12345678910111213
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	addFP64_altpriority_encoder1234567891011121314   altpriority_encoder29
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	addFP64_altpriority_encoder1234567891011121314   altpriority_encoder30
	( 
	.data(data[15:8]),
...
endmodule //addFP64_altpriority_encoder12345678910111213

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder123456789101112
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	addFP64_altpriority_encoder12345678910111213   altpriority_encoder27
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	addFP64_altpriority_encoder12345678910111213   altpriority_encoder28
	( 
	.data(data[31:16]),
...
endmodule //addFP64_altpriority_encoder123456789101112
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder123456789101112131415161718192021
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //addFP64_altpriority_encoder123456789101112131415161718192021

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder1234567891011121314151617181920
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [3:0]  data;
	...
	addFP64_altpriority_encoder12345678910111213141516   altpriority_encoder41
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder41_q),
	.zero(wire_altpriority_encoder41_zero));
	addFP64_altpriority_encoder123456789101112131415161718192021   altpriority_encoder42
	( 
	.data(data[3:2]),
...
endmodule //addFP64_altpriority_encoder1234567891011121314151617181920

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder12345678910111213141516171819
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [7:0]  data;
	...
	addFP64_altpriority_encoder123456789101112131415   altpriority_encoder39
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder39_q),
	.zero(wire_altpriority_encoder39_zero));
	addFP64_altpriority_encoder1234567891011121314151617181920   altpriority_encoder40
	( 
	.data(data[7:4]),
...
endmodule //addFP64_altpriority_encoder12345678910111213141516171819

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder123456789101112131415161718
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [15:0]  data;
	...
	addFP64_altpriority_encoder1234567891011121314   altpriority_encoder37
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder37_q),
	.zero(wire_altpriority_encoder37_zero));
	addFP64_altpriority_encoder12345678910111213141516171819   altpriority_encoder38
	( 
	.data(data[15:8]),
...
endmodule //addFP64_altpriority_encoder123456789101112131415161718

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder1234567891011121314151617
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [31:0]  data;
	...
	addFP64_altpriority_encoder12345678910111213   altpriority_encoder35
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder35_q),
	.zero(wire_altpriority_encoder35_zero));
	addFP64_altpriority_encoder123456789101112131415161718   altpriority_encoder36
	( 
	.data(data[31:16]),
...
endmodule //addFP64_altpriority_encoder1234567891011121314151617

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altpriority_encoder1234567891011
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	addFP64_altpriority_encoder123456789101112   altpriority_encoder25
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder25_q),
	.zero(wire_altpriority_encoder25_zero));
	addFP64_altpriority_encoder1234567891011121314151617   altpriority_encoder26
	( 
	.data(data[63:32]),
...
endmodule //addFP64_altpriority_encoder1234567891011
...
//lpm_add_sub DEVICE_FAMILY="Stratix V" LPM_DIRECTION="SUB" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=7 dataa datab result
//VERSION_BEGIN 17.1 cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ  VERSION_END


//lpm_add_sub DEVICE_FAMILY="Stratix V" LPM_DIRECTION="ADD" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=12 dataa datab result
//VERSION_BEGIN 17.1 cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ  VERSION_END


//lpm_add_sub DEVICE_FAMILY="Stratix V" LPM_DIRECTION="ADD" LPM_PIPELINE=1 LPM_REPRESENTATION="SIGNED" LPM_WIDTH=12 aclr clken clock dataa datab result
//VERSION_BEGIN 17.1 cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ  VERSION_END
...
//lpm_add_sub DEVICE_FAMILY="Stratix V" LPM_PIPELINE=1 LPM_REPRESENTATION="SIGNED" LPM_WIDTH=29 aclr add_sub cin clken clock cout dataa datab result
//VERSION_BEGIN 17.1 cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ  VERSION_END
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe43 <= wire_add_sub_cella_0sumout[0:0];
	// synopsys translate_off
	initial
		dffe44 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe44 <= wire_add_sub_cella_1sumout[0:0];
	// synopsys translate_off
	initial
		dffe45 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe45 <= wire_add_sub_cella_2sumout[0:0];
	// synopsys translate_off
	initial
		dffe46 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe46 <= wire_add_sub_cella_3sumout[0:0];
	// synopsys translate_off
	initial
		dffe47 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe47 <= wire_add_sub_cella_4sumout[0:0];
	// synopsys translate_off
	initial
		dffe48 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe48 <= wire_add_sub_cella_5sumout[0:0];
	// synopsys translate_off
	initial
		dffe49 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe49 <= wire_add_sub_cella_6sumout[0:0];
	// synopsys translate_off
	initial
		dffe50 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe50 <= wire_add_sub_cella_7sumout[0:0];
	// synopsys translate_off
	initial
		dffe51 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe51 <= wire_add_sub_cella_8sumout[0:0];
	// synopsys translate_off
	initial
		dffe52 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe52 <= wire_add_sub_cella_9sumout[0:0];
	// synopsys translate_off
	initial
		dffe53 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe53 <= wire_add_sub_cella_10sumout[0:0];
	// synopsys translate_off
	initial
		dffe54 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe54 <= wire_add_sub_cella_11sumout[0:0];
	// synopsys translate_off
	initial
		dffe55 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe55 <= wire_add_sub_cella_12sumout[0:0];
	// synopsys translate_off
	initial
		dffe56 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe56 <= wire_add_sub_cella_13sumout[0:0];
	// synopsys translate_off
	initial
		dffe57 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe57 <= wire_add_sub_cella_14sumout[0:0];
	// synopsys translate_off
	initial
		dffe58 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe58 <= wire_add_sub_cella_15sumout[0:0];
	// synopsys translate_off
	initial
		dffe59 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe59 <= wire_add_sub_cella_16sumout[0:0];
	// synopsys translate_off
	initial
		dffe60 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe60 <= wire_add_sub_cella_17sumout[0:0];
	// synopsys translate_off
	initial
		dffe61 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe61 <= wire_add_sub_cella_18sumout[0:0];
	// synopsys translate_off
	initial
		dffe62 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe62 <= wire_add_sub_cella_19sumout[0:0];
	// synopsys translate_off
	initial
		dffe63 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe63 <= wire_add_sub_cella_20sumout[0:0];
	// synopsys translate_off
	initial
		dffe64 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe64 <= wire_add_sub_cella_21sumout[0:0];
	// synopsys translate_off
	initial
		dffe65 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe65 <= wire_add_sub_cella_22sumout[0:0];
	// synopsys translate_off
	initial
		dffe66 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe66 <= wire_add_sub_cella_23sumout[0:0];
	// synopsys translate_off
	initial
		dffe67 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe67 <= wire_add_sub_cella_24sumout[0:0];
	// synopsys translate_off
	initial
		dffe68 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe68 <= wire_add_sub_cella_25sumout[0:0];
	// synopsys translate_off
	initial
		dffe69 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe69 <= wire_add_sub_cella_26sumout[0:0];
	// synopsys translate_off
	initial
		dffe70 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe70 <= wire_add_sub_cella_27sumout[0:0];
	// synopsys translate_off
	initial
		dffe71 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe71 <= wire_add_sub_cella_28sumout[0:0];
	// synopsys translate_off
	initial
		dffe72a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) dffe72a <= 1'b0;
		else if  (clken == 1'b1)   dffe72a <= wire_add_sub_cella_28cout[0:0];
	...
	assign
		cout = dffe72a,
		lsb_cin_wire = cin,
		result = {dffe71, dffe70, dffe69, dffe68, dffe67, dffe66, dffe65, dffe64, dffe63, dffe62, dffe61, dffe60, dffe59, dffe58, dffe57, dffe56, dffe55, dffe54, dffe53, dffe52, dffe51, dffe50, dffe49, dffe48, dffe47, dffe46, dffe45, dffe44, dffe43};
endmodule //addFP64_add_sub


//lpm_add_sub DEVICE_FAMILY="Stratix V" LPM_PIPELINE=1 LPM_REPRESENTATION="SIGNED" LPM_WIDTH=28 aclr add_sub cin clken clock dataa datab result
//VERSION_BEGIN 17.1 cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ  VERSION_END
...
`endif
	...
	wire  [0:0]   wire_add_sub_cella_25cout;
	wire  [0:0]   wire_add_sub_cella_26cout;
	wire  [27:0]   wire_add_sub_cella_datad;
	wire  [27:0]   wire_add_sub_cella_dataf;
	wire  [0:0]   wire_add_sub_cella_0sumout;
	wire  [0:0]   wire_add_sub_cella_1sumout;
	wire  [0:0]   wire_add_sub_cella_2sumout;
	wire  [0:0]   wire_add_sub_cella_3sumout;
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe100 <= wire_add_sub_cella_27sumout[0:0];
	// synopsys translate_off
	initial
		dffe73 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe73 <= wire_add_sub_cella_0sumout[0:0];
	// synopsys translate_off
	initial
		dffe74 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe74 <= wire_add_sub_cella_1sumout[0:0];
	// synopsys translate_off
	initial
		dffe75 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe75 <= wire_add_sub_cella_2sumout[0:0];
	// synopsys translate_off
	initial
		dffe76 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe76 <= wire_add_sub_cella_3sumout[0:0];
	// synopsys translate_off
	initial
		dffe77 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe77 <= wire_add_sub_cella_4sumout[0:0];
	// synopsys translate_off
	initial
		dffe78 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe78 <= wire_add_sub_cella_5sumout[0:0];
	// synopsys translate_off
	initial
		dffe79 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe79 <= wire_add_sub_cella_6sumout[0:0];
	// synopsys translate_off
	initial
		dffe80 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe80 <= wire_add_sub_cella_7sumout[0:0];
	// synopsys translate_off
	initial
		dffe81 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe81 <= wire_add_sub_cella_8sumout[0:0];
	// synopsys translate_off
	initial
		dffe82 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe82 <= wire_add_sub_cella_9sumout[0:0];
	// synopsys translate_off
	initial
		dffe83 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe83 <= wire_add_sub_cella_10sumout[0:0];
	// synopsys translate_off
	initial
		dffe84 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe84 <= wire_add_sub_cella_11sumout[0:0];
	// synopsys translate_off
	initial
		dffe85 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe85 <= wire_add_sub_cella_12sumout[0:0];
	// synopsys translate_off
	initial
		dffe86 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe86 <= wire_add_sub_cella_13sumout[0:0];
	// synopsys translate_off
	initial
		dffe87 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe87 <= wire_add_sub_cella_14sumout[0:0];
	// synopsys translate_off
	initial
		dffe88 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe88 <= wire_add_sub_cella_15sumout[0:0];
	// synopsys translate_off
	initial
		dffe89 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe89 <= wire_add_sub_cella_16sumout[0:0];
	// synopsys translate_off
	initial
		dffe90 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe90 <= wire_add_sub_cella_17sumout[0:0];
	// synopsys translate_off
	initial
		dffe91 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe91 <= wire_add_sub_cella_18sumout[0:0];
	// synopsys translate_off
	initial
		dffe92 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe92 <= wire_add_sub_cella_19sumout[0:0];
	// synopsys translate_off
	initial
		dffe93 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe93 <= wire_add_sub_cella_20sumout[0:0];
	// synopsys translate_off
	initial
		dffe94 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe94 <= wire_add_sub_cella_21sumout[0:0];
	// synopsys translate_off
	initial
		dffe95 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe95 <= wire_add_sub_cella_22sumout[0:0];
	// synopsys translate_off
	initial
		dffe96 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe96 <= wire_add_sub_cella_23sumout[0:0];
	// synopsys translate_off
	initial
		dffe97 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe97 <= wire_add_sub_cella_24sumout[0:0];
	// synopsys translate_off
	initial
		dffe98 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe98 <= wire_add_sub_cella_25sumout[0:0];
	// synopsys translate_off
	initial
		dffe99 = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   dffe99 <= wire_add_sub_cella_26sumout[0:0];
	stratixv_lcell_comb   add_sub_cella_0
	( 
	.cin(lsb_cin_wire),
	.combout(),
	...
	assign
		lsb_cin_wire = cin,
		result = {dffe100, dffe99, dffe98, dffe97, dffe96, dffe95, dffe94, dffe93, dffe92, dffe91, dffe90, dffe89, dffe88, dffe87, dffe86, dffe85, dffe84, dffe83, dffe82, dffe81, dffe80, dffe79, dffe78, dffe77, dffe76, dffe75, dffe74, dffe73};
endmodule //addFP64_add_sub1


//lpm_add_sub DEVICE_FAMILY="Stratix V" LPM_DIRECTION="ADD" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=28 cout dataa datab result
//VERSION_BEGIN 17.1 cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ  VERSION_END


//lpm_add_sub DEVICE_FAMILY="Stratix V" LPM_DIRECTION="ADD" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=27 cin dataa datab result
//VERSION_BEGIN 17.1 cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ  VERSION_END


//lpm_compare DEVICE_FAMILY="Stratix V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=7 agb dataa datab
...
//synthesis_resources = lut 301 reg 1586 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  addFP64_altfp_add_sub
	( 
	clock,
	dataa,
	datab,
	...
	wire	[11:0]	wire_add_sub4_dataa;
	wire	[11:0]	wire_add_sub4_datab;
	...
	wire	[28:0]	wire_man_res_rounding_add_sub_lower_result_int;
	wire	wire_man_res_rounding_add_sub_lower_cout;
	wire	[27:0]	wire_man_res_rounding_add_sub_lower_dataa;
	wire	[27:0]	wire_man_res_rounding_add_sub_lower_datab;
	wire	[27:0]	wire_man_res_rounding_add_sub_lower_result;
	wire	[27:0]	wire_man_res_rounding_add_sub_upper1_result_int;
	wire	wire_man_res_rounding_add_sub_upper1_cin;
	wire	[26:0]	wire_man_res_rounding_add_sub_upper1_dataa;
	wire	[26:0]	wire_man_res_rounding_add_sub_upper1_datab;
	...
	addFP64_altbarrel_shift   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	addFP64_altbarrel_shift1   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	addFP64_altpriority_encoder   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	addFP64_altpriority_encoder1234567891011   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		wire_add_sub4_dataa = exp_adjustment_add_sub_dataa_w,
		wire_add_sub4_datab = exp_adjustment_add_sub_datab_w;
	assign
	...
	assign
		...
		wire_add_sub5_dataa = exp_adjustment2_add_sub_dataa_w,
		wire_add_sub5_datab = exp_adjustment2_add_sub_datab_w;
	assign
		wire_add_sub6_result = wire_add_sub6_dataa + wire_add_sub6_datab;
	assign
		wire_add_sub6_dataa = exp_res_rounding_adder_dataa_w,
		wire_add_sub6_datab = exp_rounding_adjustment_w;
	addFP64_add_sub   man_2comp_res_lower
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(borrow_w),
	...
	addFP64_add_sub1   man_2comp_res_upper0
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b0),
	...
	addFP64_add_sub1   man_2comp_res_upper1
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b1),
	...
	addFP64_add_sub   man_add_sub_lower
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(borrow_w),
	...
	addFP64_add_sub1   man_add_sub_upper0
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b0),
	...
	addFP64_add_sub1   man_add_sub_upper1
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b1),
	...
	assign
		wire_man_res_rounding_add_sub_lower_result_int = wire_man_res_rounding_add_sub_lower_dataa + wire_man_res_rounding_add_sub_lower_datab;
	assign
		wire_man_res_rounding_add_sub_lower_result = wire_man_res_rounding_add_sub_lower_result_int[27:0],
		wire_man_res_rounding_add_sub_lower_cout = wire_man_res_rounding_add_sub_lower_result_int[28:28];
	assign
		wire_man_res_rounding_add_sub_lower_dataa = man_intermediate_res_w[27:0],
		wire_man_res_rounding_add_sub_lower_datab = man_res_rounding_add_sub_datab_w[27:0];
	assign
		wire_man_res_rounding_add_sub_upper1_result_int = {wire_man_res_rounding_add_sub_upper1_dataa, wire_man_res_rounding_add_sub_upper1_cin} + {wire_man_res_rounding_add_sub_upper1_datab, wire_man_res_rounding_add_sub_upper1_cin};
	assign
		wire_man_res_rounding_add_sub_upper1_result = wire_man_res_rounding_add_sub_upper1_result_int[27:1];
	assign
		wire_man_res_rounding_add_sub_upper1_cin = 1'b1,
		wire_man_res_rounding_add_sub_upper1_dataa = man_intermediate_res_w[54:28],
		wire_man_res_rounding_add_sub_upper1_datab = man_res_rounding_add_sub_datab_w[54:28];
	assign
...
endmodule //addFP64_altfp_add_sub
//VALID FILE
...
module addFP64 (
	...
	addFP64_altfp_add_sub	addFP64_altfp_add_sub_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.nan (sub_wire0),
