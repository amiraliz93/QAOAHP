...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix V" EXCEPTION_HANDLING="NO" PIPELINE=11 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=11 WIDTH_MAN=52 clock dataa datab nan overflow result underflow zero
...
module  altmul64_altfp_mult_heq
	( 
	clock,
	dataa,
	datab,
	...
	assign
		...
		zero = zero_ff;
endmodule //altmul64_altfp_mult_heq
//VALID FILE
...
module altmul64 (
	...
	altmul64_altfp_mult_heq	altmul64_altfp_mult_heq_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.nan (sub_wire0),
