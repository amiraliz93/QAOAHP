...
// +1.0 =  64'sd2305843009213693952
// -1.0 = -64'sd2305843009213693952
// +0.5 =  64'sd1152921504606846976
// -0.5 = -64'sd1152921504606846976
initial begin 
     a_0 = 64'sd2305843009213693952; // 1.0 in Q3.61
	  b_0 = -64'sd2305843009213693952; // -1.0 in Q3.61
	  CLK2 = 0;
	  RST2 = 0;
	  # 10
	  RST2 = 1;
	  ...
	  RST2 = 0;
	  # 4
      a_0 =  64'sd1152921504606846976; // 0.5 in Q3.61
	  b_0 = -64'sd1152921504606846976; // -0.5 in Q3.61
