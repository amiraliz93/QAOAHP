//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Stratix V" DSP_BLOCK_BALANCING="Auto" LPM_PIPELINE=7 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=8 LPM_WIDTHB=8 LPM_WIDTHP=8 MAXIMIZE_SPEED=9 clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	reg  [7:0]  result_output_reg;
	reg  [7:0]  result_extra0_reg;
	reg  [7:0]  result_extra1_reg;
	reg  [7:0]  result_extra2_reg;
	reg  [7:0]  result_extra3_reg;
	reg  [7:0]  result_extra4_reg;
	wire [7:0]    dataa_wire;
	wire [7:0]    datab_wire;
	...
	// synopsys translate_on
	always @(posedge clock)
		result_output_reg <= result_extra4_reg;
	// synopsys translate_off
	initial
		result_extra0_reg = 0;
	// synopsys translate_on
	always @(posedge clock)
		result_extra0_reg <= result_wire[15:8];
	// synopsys translate_off
	initial
		result_extra1_reg = 0;
	// synopsys translate_on
