//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DEVICE_FAMILY="Stratix V" DSP_BLOCK_BALANCING="Auto" LPM_PIPELINE=5 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=53 LPM_WIDTHB=53 LPM_WIDTHP=106 LPM_WIDTHS=1 clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	reg  [52:0]  dataa_input_reg;
	reg  [52:0]  datab_input_reg;
	reg  [105:0]  result_output_reg;
	reg  [105:0]  result_extra0_reg;
	reg  [105:0]  result_extra1_reg;
	reg  [105:0]  result_extra2_reg;
	wire [52:0]    dataa_wire;
	wire [52:0]    datab_wire;
	wire [105:0]    result_wire;
	...
	// synopsys translate_on
	always @(posedge clock)
		result_extra0_reg <= result_wire[105:0];
	// synopsys translate_off
	initial
		result_extra1_reg = 0;
	// synopsys translate_on
