//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Stratix V" DSP_BLOCK_BALANCING="Auto" LPM_PIPELINE=7 LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=24 LPM_WIDTHB=24 LPM_WIDTHP=48 MAXIMIZE_SPEED=5 clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	reg  [47:0]  result_extra3_reg;
	reg  [47:0]  result_extra4_reg;
