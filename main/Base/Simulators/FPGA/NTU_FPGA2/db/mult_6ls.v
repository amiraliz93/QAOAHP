//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DEVICE_FAMILY="Stratix V" DSP_BLOCK_BALANCING="Auto" LPM_PIPELINE=14 LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=32 LPM_WIDTHB=32 LPM_WIDTHP=64 MAXIMIZE_SPEED=9 clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	reg  [63:0]  result_extra2_reg;
	reg  [63:0]  result_extra3_reg;
	reg  [63:0]  result_extra4_reg;
	reg  [63:0]  result_extra5_reg;
	reg  [63:0]  result_extra6_reg;
	reg  [63:0]  result_extra7_reg;
	reg  [63:0]  result_extra8_reg;
	reg  [63:0]  result_extra9_reg;
	reg  [63:0]  result_extra10_reg;
	reg  [63:0]  result_extra11_reg;
	...
	// synopsys translate_on
	always @(posedge clock)
		result_output_reg <= result_extra11_reg;
	// synopsys translate_off
	initial
		result_extra0_reg = 0;
	// synopsys translate_on
