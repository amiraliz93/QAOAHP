...
//altfp_mult DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix V" EXCEPTION_HANDLING="NO" PIPELINE=11 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=11 WIDTH_MAN=52 clock dataa datab nan overflow result underflow zero
...
//lpm_add_sub DEVICE_FAMILY="Stratix V" LPM_PIPELINE=1 LPM_WIDTH=12 aclr cin clken clock dataa datab result
...
//lpm_add_sub DEVICE_FAMILY="Stratix V" LPM_PIPELINE=0 LPM_WIDTH=13 cin dataa datab result
//VERSION_BEGIN 17.1 cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ  VERSION_END


//lpm_add_sub DEVICE_FAMILY="Stratix V" LPM_DIRECTION="SUB" LPM_PIPELINE=0 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=13 dataa datab result
//VERSION_BEGIN 17.1 cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ  VERSION_END


//lpm_add_sub DEVICE_FAMILY="Stratix V" LPM_PIPELINE=0 LPM_WIDTH=54 dataa datab result
//VERSION_BEGIN 17.1 cbx_cycloneii 2017:10:25:18:06:53:SJ cbx_lpm_add_sub 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ cbx_nadder 2017:10:25:18:06:53:SJ cbx_stratix 2017:10:25:18:06:53:SJ cbx_stratixii 2017:10:25:18:06:53:SJ  VERSION_END


//lpm_mult DEDICATED_MULTIPLIER_CIRCUITRY="YES" DEVICE_FAMILY="Stratix V" LPM_PIPELINE=5 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=53 LPM_WIDTHB=53 LPM_WIDTHP=106 LPM_WIDTHS=1 aclr clken clock dataa datab result
...
endmodule //altmul64_mult

//synthesis_resources = lut 93 reg 501 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altmul64_altfp_mult
	( 
	clock,
	dataa,
	datab,
	...
	wire  [52:0]   wire_man_product2_mult_dataa;
	wire  [52:0]   wire_man_product2_mult_datab;
	...
	assign
		...
		wire_exp_adj_adder_datab = {expmod[12:0]};
	assign
	...
	assign
		...
		wire_man_round_adder_datab = {{53{1'b0}}, man_round_carry};
	altmul64_mult   man_product2_mult
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
...
module altmul64 (
	...
	altmul64_altfp_mult	altmul64_altfp_mult_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.nan (sub_wire0),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altmul64.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altmul64.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altmul64.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altmul64_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altmul64_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altmul64.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altmul64.cmp TRUE TRUE
