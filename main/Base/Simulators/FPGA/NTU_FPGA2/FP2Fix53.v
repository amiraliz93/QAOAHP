...
module FP2Fix53 (
		...
		output wire [55:0] q       //      q.q
	);

	FP2Fix53_0002 fp2fix53_inst (
		.clk    (clk),    //    clk.clk
...
// Retrieval info: 	<generic name="fp_exp" value="11" />
// Retrieval info: 	<generic name="fp_man" value="52" />
...
// Retrieval info: 	<generic name="fxpt_width" value="56" />
...
// IPFS_FILES : FP2Fix53.vo
// RELATED_FILES: FP2Fix53.v, dspba_library_package.vhd, dspba_library.vhd, FP2Fix53_0002.vhd
