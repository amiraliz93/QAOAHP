...
# ----------------------------------------
# If Fix53toFP64 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 25.1 1129 win32 2026.04.18.01:27:37
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "Fix53toFP64"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Fix53toFP64.vo"
}
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L stratixv_ver -L stratixv_hssi_ver -L stratixv_pcie_hip_ver $TOP_LEVEL_NAME
}
